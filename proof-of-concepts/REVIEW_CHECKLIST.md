# Per-milestone PR review checklist (Claude)

Apply to **every** milestone PR before recommending merge. The bar is "meets the design,"
not "looks reasonable." Spec = `RUN_HISTORY_ARCHITECTURE.md` (§14 acceptance, §15 decisions).
...
- [ ] No literal credential accepted on the command line.
